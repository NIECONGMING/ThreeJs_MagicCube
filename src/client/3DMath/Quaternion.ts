...
export class Quaternion {
     ...
     * @discreption 平滑曲线插值
    */
	public static slerp( qa:Quaternion, qb:Quaternion, qm:Quaternion, t:number ) {
    ...
    */
	...
	public static multiplyQuaternionsFlat( dst, dstOffset, src0, srcOffset0, src1, srcOffset1 ) {
	...
	public angleTo( q ) {
		...
		return 2 * Math.acos( Math.abs( CommonUntil.clamp( this.dot( q ), - 1, 1 ) ) );

	}


	public rotateTowards( q, step ) {
    ...
    //四元数插值
	public slerpQuaternions( qa, qb, t ) {
